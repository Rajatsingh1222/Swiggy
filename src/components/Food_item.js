...
console.log(Items)
    return (
      ...
      {!veg? Items.map((item)=>item.card.info.isVeg==1?
       <>
        (<div key={item.card.info.id} className=" w-7/12 h-[115px] cursor-pointer bg-gray-200 shadow-gray-300 flex justify-around  ml-[310px] hover:bg-gray-300 transition-all duration-300 ">
       ...
       <div>
        ...
        {item.card.info.isVeg?<div className="m-2 text-gray-600">☘️</div>:"♦️"}
